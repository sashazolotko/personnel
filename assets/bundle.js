...
/***/ function(module, exports, __webpack_require__) {
	...
	var AppComponent = __webpack_require__(/*! ./app */ 157);
	__webpack_require__(/*! ./css/style.css */ 162);
	React.render(React.createElement(AppComponent, null), document.body);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(/*! react */ 1);
	var LoginComponent = __webpack_require__(/*! ./loginComponent */ 158);
	var ContentComponent = __webpack_require__(/*! ./contentComponent */ 159);
	var AppComponent = React.createClass({
	    ...
	    onChildChange: function onChildChange() {
	    ...
	    render: function render() {
	        return React.createElement(
	            'div',
	            null,
	            React.createElement(LoginComponent, { visible: !this.state.isContentShow, parentCallback: this.onChildChange }),
	            React.createElement(ContentComponent, { visible: this.state.isContentShow, parentCallback: this.onChildChange })
	        );
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var LoginComponent = React.createClass({
	    ...
	    handlerChange: function handlerChange(evt) {
	    ...
	    render: function render() {
	        return React.createElement(
	            'div',
	            { className: 'login' + (this.props.visible ? '' : ' novisible') },
	            React.createElement(
	                'form',
	                null,
	                React.createElement(
	                ...
	                React.createElement('input', { type: 'text', value: this.state.login, onChange: this.handlerChange, id: 'login' }),
	                React.createElement(
	                    'label',
	                    { htmlFor: '#password' },
	                    'Password'
	                ),
	                React.createElement('input', { type: 'password', id: 'password', onChange: this.handlerChange, value: this.state.password }),
	                React.createElement(
	                    'button',
	                    { type: 'button', onClick: this.handlerSubmit },
	                    'Submit'
	                ),
	                React.createElement(
	                    'span',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(/*! react */ 1);
	var EmployeeComponent = __webpack_require__(/*! ./employeeComponent */ 160);
	var ModalLink = __webpack_require__(/*! ./modalComponents */ 161);
	var ContentComponent = React.createClass({
	    ...
	    handleToggleMode: function handleToggleMode() {
	        this.setState({
	            mode: 'Create',
	            selected: false,
	            firstname: '',
	    ...
	    handleDeleteButton: function handleDeleteButton(evt) {
	    ...
	    handleSelect: function handleSelect(indx, evt) {
	    ...
	    handlerExit: function handlerExit() {
	        this.setState({
	            mode: 'Create',
	            firstname: '',
	            lastname: '',
	    ...
	    render: function render() {
	        var personnel = this.state.personnel.map((function (p, indx) {
	            return React.createElement(
	                'li',
	                { className: 'employee', onClick: this.handleSelect.bind(undefined, indx) },
	                React.createElement(EmployeeComponent, { p: p }),
	                React.createElement(
	                    'button',
	                    { type: 'button', id: 'deleteButton', className: 'deleteButton' },
	                    React.createElement(ModalLink, { buttonName: 'Delete', onConfirm: this.handleDeleteButton.bind(this, indx) })
	                )
	            );
	        }).bind(this));
	        return React.createElement(
	            'div',
	            { className: 'content' + (this.props.visible ? '' : ' novisible') },
	            React.createElement(
	                'div',
	                { className: 'header' },
	                React.createElement(
	                ...
	                React.createElement(
	                    'button',
	                    { type: 'button', onClick: this.handlerExit },
	                    'Exit'
	                )
	            ),
	            React.createElement(
	            ...
	            React.createElement(
	                'div',
	                { className: 'right' + (this.state.active ? '' : ' hidden') },
	                React.createElement(
	                    'h2',
	                    null,
	                    this.state.mode,
	                ...
	                React.createElement(
	                    ...
	                    React.createElement('input', { type: 'text', id: 'firstname', value: this.state.firstname,
	                    ...
	                    React.createElement('input', { type: 'text', id: 'lastname', value: this.state.lastname,
	                        onChange: this.handleInput }),
	                    React.createElement(
	                        'label',
	                        { htmlFor: '#post' },
	                    ...
	                    React.createElement('input', { type: 'text', id: 'post', value: this.state.post,
	                        onChange: this.handleInput }),
	                    React.createElement(
	                        'button',
	                        { type: 'button', onClick: this.handleSaveButton },
	                        'Save'
	                    )
	                )
	            ),
	            React.createElement(
	                ...
	                React.createElement(
	                    'button',
	                    { type: 'button', onClick: this.handleToggleMode },
	                    'Add'
	                )
	            )
	        );
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                this.props.p.firstname + ' ' + this.props.p.lastname
	            ),
	            React.createElement(
	                'p',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Modal = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(
	            'div',
	            { className: 'ModalBackdrop', onClick: this.handleBackdropClick },
	            React.createElement(
	                'div',
	                { className: 'ModalContent', onClick: this.killClick },
	                this.props.children
	            )
	        );
	    }
	...
	var ModalLink = React.createClass({
	    ...
	    renderLayer: function renderLayer() {
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    'button',
	                    { id: 'yesButton', onClick: this.onConfirm },
	                    'Yes'
	                ),
	                React.createElement(
	                    'button',
	                    { id: 'noButton', onRequestClose: this.handleClick },
	                    'No'
	                )
	            )
	        );
	    ...
	    render: function render() {
	        return React.createElement(
	            'a',
	            { href: '#', id: 'modalLink', onClick: this.handleClick },
...
/***/ function(module, exports, __webpack_require__) {
	...
	// load the styles
	var content = __webpack_require__(/*! !./../../~/css-loader!./style.css */ 163);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "body {\n    font-family: Arial;\n}\ndiv.hidden {\n    visibility: hidden;\n}\ndiv.novisible {\n    display: none;\n}\n/*===========================Login===*/\ndiv.login {\n    background-color: #f5f5f5;\n    width: 50%;\n    margin: 0 auto;\n    padding-top: 10px;\n    padding-bottom: 10px;\n}\ndiv.login h1 {\n    font-size: 28px;\n    margin-top: 10px;\n    margin-bottom: 0;\n    color: #101010;\n    text-align: center;\n}\ndiv.login form {\n    margin-left: 20px;\n    margin-bottom: 5px;\n}\ndiv.login label {\n    margin-left: 5px;\n    font-size: 20px;\n    color: #101010;\n}\ndiv.login input {\n    margin-bottom: 5px;\n    display: block;\n    width: 90%;\n    height: 20px;\n    border: 1px solid #101010;\n    border-radius: 5px;\n}\ndiv.login button {\n    margin-top: 5px;\n    margin-left: 45%;\n    background-color: #2a6496;\n    color: #fff;\n    font-weight: 600;\n    padding: 5px 20px 5px 20px;\n    border: 0;\n    cursor: pointer;\n}\ndiv.login button:hover {\n    background-color: #0f3e96;\n}\ndiv.login .errorBlock {\n    display: block;\n    color: maroon;\n    margin-left: 40%;\n    margin-top: 5px;\n}\n\n/*================================Content==================*/\ndiv.content {\n    border-left: 1px solid #f5f5f5;\n    border-right: 1px solid #f5f5f5;\n    position: absolute;\n    width: 70%;\n    left: 15%;\n}\n/*============================Content header=====*/\ndiv.content .header {\n    background-color: #f5f5f5;\n    overflow: hidden;\n}\ndiv.content .header h1 {\n    font-size: 28px;\n    color: #101010;\n    padding-left: 5%;\n    width: 89%;\n    float: left;\n}\ndiv.content .header button {\n    margin-top: 3%;\n    margin-right: 5px;\n    padding: 5px 10px 5px 10px;\n    background-color: #d9534f;\n    color: #fff;\n    cursor: pointer;\n    border: 0;\n}\ndiv.content .header button:hover {\n    background-color: #ac2925;\n}\n/*============================Content right=======*/\ndiv.content .right {\n    position: relative;\n    width: 50%;\n    float: right;\n}\ndiv.content .right h2 {\n    text-align: center;\n    font-size: 24px;\n    color: #101010;\n}\ndiv.content .right form {\n    margin-left: 20px;\n    margin-bottom: 5px;\n}\ndiv.content .right form button {\n    margin-top: 7px;\n    margin-bottom: 7px;\n    margin-left: 75%;\n    padding: 5px 10px 5px 10px;\n    background-color: #fff;\n    border: 2px solid #4cae4c;\n    color: #4cae4c;\n    cursor: pointer;\n}\ndiv.content .right form button:hover {\n    border: 2px solid forestgreen;\n    color: forestgreen;\n}\ndiv.content .right label{\n    margin-left: 5px;\n    font-size: 20px;\n    color: #101010;\n}\ndiv.content .right input{\n    margin-bottom: 5px;\n    display: block;\n    width: 90%;\n    height: 20px;\n    border: 1px solid #101010;\n    border-radius: 5px;\n}\n/*============================Content left======*/\ndiv.content .left {\n    clear: both;\n    position: relative;\n    width: 49%;\n    float: left;\n}\ndiv.content .left ul {\n    margin: 0;\n    padding-left: 5px;\n    height: 500px;\n    overflow-y: scroll;\n}\ndiv.content .left ul li {\n    overflow: hidden;\n}\ndiv.content .left .employee {\n    list-style-type: none;\n    border-bottom: 2px solid #101010;\n}\ndiv.content .left .employee .employeeData {\n    width: 50%;\n    float: left;\n}\ndiv.content .left .employee .employeeData {\n    font-size: 18px;\n}\ndiv.content .left .employee .employeeData p {\n    margin-left: 10px;\n    color: #101010;\n}\ndiv.content .left .employee .employeeData p.employeeName {\n    font-weight: 400;\n    margin-bottom: 5px;\n}\ndiv.content .left .employee .employeeData p.employeePost {\n    font-size: 13px;\n    margin-top: 5px;\n}\n\ndiv.content .left ul li .deleteButton a {\n    text-decoration: none;\n    color: #d9534f;\n}\ndiv.content .left ul li .deleteButton a:link {\n    color: #d9534f;\n}\ndiv.content .left ul li .deleteButton a:hover {\n    color: #ac2925;\n}\ndiv.content .left ul li .deleteButton {\n    border: 2px solid #d9534f;\n    background-color: #fff;\n    margin-top: 5px;\n    margin-right: 5px;\n    float: right;\n}\ndiv.content .left ul li .deleteButton:hover {\n    border: 2px solid #ac2925;\n}\n/*============================Content footer=====*/\ndiv.content .footer {\n    position: relative;\n    clear: both;\n}\ndiv.content .footer {\n    background-color: #f5f5f5;\n    margin-top: 5px;\n}\ndiv.content .footer button {\n    margin-left: 10px;\n    padding: 5px 20px 5px 20px;\n    margin-bottom: 10px;\n    margin-top: 10px;\n    background-color: #4cae4c;\n    border: 0;\n    color: #fff;\n    cursor: pointer;\n}\ndiv.content .footer button:hover {\n    background-color: forestgreen;\n}\n\n/*====================Modal=========*/\n.ModalBackdrop {\n    position: fixed;\n    left: 0;\n    right: 0;\n    top: 0;\n    bottom: 0;\n    background: rgba(0,0,0,0.5);\n}\n\n.ModalContent {\n    background: white;\n    margin-left: auto;\n    margin-right: auto;\n    margin-top: 25px;\n    padding-top: 10px;\n    width: 200px;\n    height: 50px;\n    text-align: center;\n    border-radius: 10px;\n}\n.buttonsRow {\n    display: block;\n}\n.buttonsRow button {\n    margin-left: 10px;\n    background-color: #fff;\n    border: 1px solid #f5f5f5;\n    color: #ccc;\n    cursor: pointer;\n}\n.buttonsRow #yesButton:hover {\n    color: #398439;\n}\n.buttonsRow #noButton:hover {\n    color: #101010;\n}\n", ""]);
